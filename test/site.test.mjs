...
test("search engines receive truthful site, software, and breadcrumb data", async () => {
  ...
  for (const [relativePath, name, version, screenshotCount] of [
    ["products/vibermate/index.html", "ViberMate", "0.1.12", 5],
...
test("product pages expose the supported install and release paths", async () => {
  const expectations = [
    [
      ...
      "https://github.com/vibe-agi/vibermate/releases/tag/v0.1.12",
    ],
    [
      "products/hideout/index.html",
...
test("ViberMate release guidance stays current in both languages", async () => {
  for (const relativePath of [
    "products/vibermate/index.html",
    "zh/products/vibermate/index.html",
  ]) {
    const html = await read(relativePath);
    assert.ok(html.includes("v0.1.12"), relativePath);
    assert.ok(html.includes("https://github.com/vibe-agi/vibermate/releases/tag/v0.1.12"), relativePath);
